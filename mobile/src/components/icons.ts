// Ícones do app — espelha app/components/ui/icons.ts (web) sobre lucide-react-native.
// Use SEMPRE estes nomes (não importe de 'lucide-react-native' direto nas telas).
export {
  // Navegação por papel
